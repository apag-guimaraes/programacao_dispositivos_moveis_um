...
3. link:aula_tres/[Densidade independente de Pixels / Exemplo prático: App Lanchonete, IMC e Calculadora]
...
14. link:aula_quatorze/[RecyclerView e CardView]

15. link:aula_quinza/[Atividades resolvidas]
