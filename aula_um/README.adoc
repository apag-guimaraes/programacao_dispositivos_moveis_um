...
2. Camada de abstração de hardware: funciona como uma ponte entre o kernel e as bibliotecas nativas, abstraindo os detalhes específicos do hardware. Dessa forma, o Android pode ser usado em diferentes dispositivos sem a necessidade de reescrever os códigos das camadas superiores.
