...
import androidx.appcompat.app.AppCompatActivity
class MainActivity : AppCompatActivity() {
    private lateinit var buttonOval: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main)
        // Inicialização da View após o setContentView
        buttonOval = findViewById(R.id.buttonOval)
        buttonOval.setOnClickListener {
            // Em Kotlin, dentro da Activity, usamos apenas 'this' como contexto
            Toast.makeText(this, "Botão oval clicado!", Toast.LENGTH_SHORT).show()
        }
    }
} 
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Expressão Lambda limpa para o listener de clique
        fab.setOnClickListener { view ->
            // Exibe o Snackbar utilizando a view do clique
            Snackbar.make(view, "Here's a Snackbar", Snackbar.LENGTH_LONG)
