...
<body>
    ...
    <p>A tabela abaixo descreve as cores definidas no arquivo <code>colors.xml</code>, com base no <strong>Material Theme Builder</strong> (Material Design 3), incluindo suas aplicações no contexto de um aplicativo Android com um <code>EditText</code> e botões "Submit", "Cancel" e "Explore".</p>
    <table>
        <tr>
            <th>Cor</th>
            <th>Aplicações</th>
        ...
        <tr>
            ...
            <td>Texto ou ícones principais sobre o fundo. Exemplo: Texto digitado no <code>EditText</code>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Texto ou ícones sobre superfícies, incluindo dicas (hints). Exemplo: Texto e dica "Enter your name" no <code>EditText</code>.</td>
        </tr>
    </table>
    <h2>Notas</h2>
    <ul>
        ...
        <li><strong>Aplicação</strong>: Usadas no aplicativo Android com <code>EditText</code> e botões, com <code>error</code> aplicado dinamicamente para validação.</li>
        <li><strong>Acessibilidade</strong>: Cores "on" (ex.: <code>onPrimary</code>, <code>onSurface</code>) garantem legibilidade com alto contraste.</li>
    </ul>
</body>
</html>
