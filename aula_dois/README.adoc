...
O Material Theme Builder é a ferramenta oficial do Google para criar esquemas de cores baseados no Material Design 3, segue o link para acesso: https://material-foundation.github.io/material-theme-builder/. Acesso em: 09 de jul. 2025. Para saber mais informações sobre cores, acesse o link: https://m3.material.io/styles/color/system/how-the-system-works.
...
A tabela abaixo descreve as cores definidas no arquivo colors.xml, com base no Material Theme Builder (disponível em: https://material-foundation.github.io/material-theme-builder/). 
