...
=== EXEMPLOS PRATICOS (linear layout, view, activity e intent)
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonClicar.setOnClickListener {
            val msg = editTextPalavra.text.toString()
            textViewResultado.text = msg
            val it = Intent(this, SegundaActivity::class.java).apply {
                putExtra("dados", msg)
            }
            startActivity(it)
        }
...
class SegundaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_segunda)
        textViewResultado2 = findViewById(R.id.textViewResultado2)
        val palavra = intent.getStringExtra("dados")
        textViewResultado2.text = palavra
        layout2 = findViewById(R.id.layout2)
        layout2.setBackgroundColor(ContextCompat.getColor(this,R.color.pink))
    }
}
...
Para garantir qualidade visual e evitar distorções nas imagens do seu aplicativo, utilize as ferramentas Vector Asset e Image Asset integradas ao Android Studio. Ao optar pelo formato .SVG, o Android Studio gera automaticamente um arquivo XML correspondente. Essa abordagem garante a elasticidade, permitindo a adaptação a qualquer densidade de tela e tamanho em DP, sem nenhuma perda de resolução.
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonClick = findViewById<Button>(R.id.buttonSubmit)
        buttonClick.setOnClickListener {
            val name = editTextName.text.toString()
            if (name.isEmpty()) {
                Toast.makeText(this, "Please enter a name", Toast.LENGTH_SHORT).show()
            } else {
                // Utilizando interpolação de string para construir a mensagem
                val message = "Hello World, $name!"
