...
class JavaActivity : AppCompatActivity() {
    private lateinit var textViewJava: TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_java)
        textViewJava = findViewById(R.id.textViewJava)
        val msg = intent.getStringExtra("dados")
        textViewJava.text = msg
    }
}
...
class PhpActivity : AppCompatActivity() {
    private lateinit var textViewPhp: TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_php)
        textViewPhp = findViewById(R.id.textViewPhp)
        val msg = intent.getStringExtra("dados")
        textViewPhp.text = msg
    }
}
